...
impl App {
    ...
    async fn perform_fork(
        ...
        path: PathBuf,
        nth_user_message: usize,
        cfg: aish_core::config::Config,
    ) -> aish_core::error::Result<aish_core::NewConversation> {
        self.server
            .fork_conversation(cfg, path, nth_user_message)
            .await
    }
    ...
    fn install_forked_conversation(
        ...
        tui: &mut tui::Tui,
        cfg: aish_core::config::Config,
        new_conv: aish_core::NewConversation,
        nth_user_message: usize,
        prefill: &str,
    ) {
