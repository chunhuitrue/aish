use anyhow::Result;
pub use aish_protocol::protocol::SandboxPolicy;

pub fn parse_policy(value: &str) -> Result<SandboxPolicy> {
    match value {
        "read-only" => Ok(SandboxPolicy::ReadOnly),
        "current-dir-write" => Ok(SandboxPolicy::new_current_dir_write_policy()),
...
mod tests {
    ...
    fn rejects_external_sandbox_json() {
        let payload = serde_json::to_string(
            &aish_protocol::protocol::SandboxPolicy::ExternalSandbox {
