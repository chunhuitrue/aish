...
use aish_utils_cargo_bin::CargoBinError;
...
const RESOURCE_URI: &str = "memo://aish/example-note";

fn stdio_server_bin() -> Result<PathBuf, CargoBinError> {
    aish_utils_cargo_bin::cargo_bin("test_stdio_server")
}
    ...
    assert_eq!(
        ...
        ListResourceTemplatesResult {
            ...
            resource_templates: vec![ResourceTemplate {
                annotations: None,
                description: Some(
                    "Template for memo://aish/{slug} resources used in tests.".to_string()
                ),
                mime_type: Some("text/plain".to_string()),
                name: "aish-memo".to_string(),
                title: Some("Aish Memo".to_string()),
                uri_template: "memo://aish/{slug}".to_string(),
            }],
        }
    );
