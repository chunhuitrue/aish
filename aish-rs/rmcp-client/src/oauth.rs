...
//!
//! If the keyring is not available or fails, we fall back to AISH_HOME/.credentials.json which is consistent with other coding CLI agents.
...
use aish_keyring_store::DefaultKeyringStore;
use aish_keyring_store::KeyringStore;
use rmcp::transport::auth::AuthorizationManager;
use tokio::sync::Mutex;

use crate::find_aish_home::find_aish_home;

const KEYRING_SERVICE: &str = "Aish MCP Credentials";
...
mod tests {
    ...
    use aish_keyring_store::tests::MockKeyringStore;
    ...
    impl TempCodexHome {
        fn new() -> Self {
            ...
            let dir = tempdir().expect("create AISH_HOME temp dir");
            unsafe {
