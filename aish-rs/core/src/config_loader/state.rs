...
use crate::config_loader::types::ConfigLayer;
use crate::config_loader::types::ConfigLayerMetadata;
use crate::config_loader::types::ConfigLayerSource;
...
impl ConfigLayerEntry {
    ...
    // Get the `.aish/` folder associated with this config layer, if any.
...
fn verify_layer_ordering(layers: &[ConfigLayerEntry]) -> std::io::Result<Option<usize>> {
    ...
    // further verify that there is at most one user config layer.
