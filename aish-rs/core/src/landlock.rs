    ...
    P: AsRef<Path>,
{
    ...
    let arg0 = Some("aish-linux-sandbox");
    spawn_child_async(
        aish_linux_sandbox_exe.as_ref().to_path_buf(),
        args,
        arg0,
        command_cwd,
        sandbox_policy,
...
/// Converts the sandbox policy into the CLI invocation for `aish-linux-sandbox`.
