...
use aish_apply_patch::ApplyPatchAction;
use aish_apply_patch::ApplyPatchFileChange;
...
pub fn assess_patch_safety(
        ...
        || policy == AskForApproval::OnFailure
    {
        ...
        SafetyCheck::Reject {
            reason: "writing to a path outside of the current working directory; rejected by user approval settings"
                .to_string(),
        }
    } else {
        SafetyCheck::AskUser
...
fn is_write_patch_constrained_to_writable_paths(
    ...
    let writable_roots = match sandbox_policy {
        ...
        SandboxPolicy::CurrentDirWrite { .. } => sandbox_policy.get_writable_roots_with_cwd(cwd),
    };
...
mod tests {
    ...
    fn test_writable_roots_constraint() {
        ...
        // Policy limited to the current directory; exclude system temp roots.
        // Note: cwd is automatically included as a writable root.
        let policy_current_dir_only = SandboxPolicy::CurrentDirWrite {
    ...
    fn external_sandbox_auto_approves_in_on_request() {
        ...
        let policy = SandboxPolicy::ExternalSandbox {
            network_access: aish_protocol::protocol::NetworkAccess::Enabled,
        };
