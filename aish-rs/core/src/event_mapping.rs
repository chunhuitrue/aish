use aish_protocol::items::AgentMessageContent;
use aish_protocol::items::AgentMessageItem;
use aish_protocol::items::ReasoningItem;
use aish_protocol::items::TurnItem;
use aish_protocol::items::UserMessageItem;
use aish_protocol::items::WebSearchItem;
    ...
    fn skips_user_instructions_and_env() {
        let items = vec![
            ...
            ResponseItem::Message {
                ...
                role: "user".to_string(),
                content: vec![ContentItem::InputText {
                    text: "# AISH.md instructions for test_directory\n\n<INSTRUCTIONS>\ntest_text\n</INSTRUCTIONS>".to_string(),
                }],
            },
            ResponseItem::Message {
                id: None,
