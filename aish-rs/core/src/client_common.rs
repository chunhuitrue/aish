...
pub use aish_api::common::ResponseEvent;
use aish_apply_patch::APPLY_PATCH_TOOL_INSTRUCTIONS;
...
#[cfg(test)]
mod tests {
    use aish_api::ResponsesApiRequest;
    use aish_api::common::OpenAiVerbosity;
    use aish_api::common::TextControls;
    ...
    fn get_full_instructions_no_user_content() {
        ...
        // All models now use default fallback, which does not need special apply_patch instructions
        let test_cases = vec![
