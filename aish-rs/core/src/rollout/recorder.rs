...
use aish_protocol::protocol::ResumedHistory;
use aish_protocol::protocol::RolloutItem;
use aish_protocol::protocol::RolloutLine;
use aish_protocol::protocol::SessionMeta;
...
///
/// ```ignore
/// $ jq -C . ~/.aish/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// $ fx ~/.aish/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// ```
#[derive(Clone)]
...
fn create_log_file(
    ...
    // Resolve ~/.aish/sessions/YYYY/MM/DD and create it if missing.
