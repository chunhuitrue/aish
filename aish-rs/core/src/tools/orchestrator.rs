...
impl ToolOrchestrator {
    ...
    pub async fn run<Rq, Out, T>(
        ...
        req: &Rq,
        tool_ctx: &ToolCtx<'_>,
        turn_ctx: &crate::aish::TurnContext,
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        let initial_attempt = SandboxAttempt {
            ...
            aish_linux_sandbox_exe: turn_ctx.aish_linux_sandbox_exe.as_ref(),
        };
        ...
        match tool.run(req, &initial_attempt, tool_ctx).await {
            ...
            Err(ToolError::Codex(AishErr::Sandbox(SandboxErr::Denied { output }))) => {
                if !tool.escalate_on_failure() {
                    return Err(ToolError::Codex(AishErr::Sandbox(SandboxErr::Denied {
                        output,
                    })));
                }
