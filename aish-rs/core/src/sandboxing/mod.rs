...
use crate::spawn::AISH_SANDBOX_NETWORK_DISABLED_ENV_VAR;
use crate::tools::sandboxing::SandboxablePreference;
pub use aish_protocol::models::SandboxPermissions;
...
pub(crate) enum SandboxTransformError {
    #[error("missing aish-linux-sandbox executable path")]
...
impl SandboxManager {
    ...
    pub(crate) fn transform(
        ...
        if !policy.has_full_network_access() {
            env.insert(
                AISH_SANDBOX_NETWORK_DISABLED_ENV_VAR.to_string(),
                "1".to_string(),
            );
        }
        ...
        let (command, sandbox_env, arg0_override) = match sandbox {
            ...
            SandboxType::MacosSeatbelt => {
                ...
                seatbelt_env.insert(AISH_SANDBOX_ENV_VAR.to_string(), "seatbelt".to_string());
                let mut args =
            ...
            SandboxType::LinuxSeccomp => {
                let exe = aish_linux_sandbox_exe
