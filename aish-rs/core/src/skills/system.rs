...
const SYSTEM_SKILLS_MARKER_FILENAME: &str = ".aish-system-skills.marker";
const SYSTEM_SKILLS_MARKER_SALT: &str = "v1";

/// Returns the on-disk cache location for embedded system skills.
///
/// This is typically located at `AISH_HOME/skills/.system`.
...
/// Installs embedded system skills into `AISH_HOME/skills/.system`.
///
