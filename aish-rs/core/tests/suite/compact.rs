    ...
    fn normalize_inputs(values: &[serde_json::Value]) -> Vec<serde_json::Value> {
        values
            ...
            .filter(|value| {
                ...
                !text.is_some_and(|text| text.starts_with("# AISH.md instructions for "))
            })
            .cloned()
            .collect()
    }
...
async fn auto_compact_counts_encrypted_reasoning_before_last_user() {
    ...
    let compacted_history = vec![
        aish_protocol::models::ResponseItem::Message {
            id: None,
        ...
        aish_protocol::models::ResponseItem::Compaction {
