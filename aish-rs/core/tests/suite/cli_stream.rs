...
use aish_core::protocol::GitInfo;
...
/// 2. Configures codex to read from this fixture via AISH_RS_SSE_FIXTURE env var
...
async fn integration_git_info_unit_test() {
    ...
    let git_info = aish_core::git_info::collect_git_info(&git_repo).await;
