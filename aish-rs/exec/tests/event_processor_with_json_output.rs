...
use aish_core::protocol::McpInvocation;
...
use aish_exec::event_processor_with_jsonl_output::EventProcessorWithJsonOutput;
use aish_exec::exec_events::AgentMessageItem;
use aish_exec::exec_events::CommandExecutionItem;
use aish_exec::exec_events::CommandExecutionStatus;
use aish_exec::exec_events::ErrorItem;
use aish_exec::exec_events::ItemCompletedEvent;
use aish_exec::exec_events::ItemStartedEvent;
use aish_exec::exec_events::ItemUpdatedEvent;
use aish_exec::exec_events::McpToolCallItem;
use aish_exec::exec_events::McpToolCallItemError;
use aish_exec::exec_events::McpToolCallItemResult;
use aish_exec::exec_events::McpToolCallStatus;
use aish_exec::exec_events::PatchApplyStatus;
use aish_exec::exec_events::PatchChangeKind;
use aish_exec::exec_events::ReasoningItem;
use aish_exec::exec_events::ThreadErrorEvent;
use aish_exec::exec_events::ThreadEvent;
use aish_exec::exec_events::ThreadItem;
use aish_exec::exec_events::ThreadItemDetails;
use aish_exec::exec_events::ThreadStartedEvent;
use aish_exec::exec_events::TodoItem as ExecTodoItem;
use aish_exec::exec_events::TodoListItem as ExecTodoListItem;
use aish_exec::exec_events::TurnCompletedEvent;
use aish_exec::exec_events::TurnFailedEvent;
use aish_exec::exec_events::TurnStartedEvent;
use aish_exec::exec_events::Usage;
use aish_exec::exec_events::WebSearchItem;
...
use aish_protocol::protocol::ExecCommandOutputDeltaEvent;
use aish_protocol::protocol::ExecOutputStream;
...
fn session_configured_produces_thread_started_event() {
    ...
    let session_id =
        aish_protocol::ConversationId::from_string("67e55044-10b1-426f-9247-bb680e5fe0c8").unwrap();
...
fn task_started_produces_turn_started_event() {
    ...
    let out = ep.collect_thread_events(&event(
        "t1",
        EventMsg::TaskStarted(aish_core::protocol::TaskStartedEvent {
...
fn plan_update_emits_todo_list_started_updated_and_completed() {
    ...
    let complete = event(
        "p3",
        EventMsg::TaskComplete(aish_core::protocol::TaskCompleteEvent {
...
fn error_event_produces_error() {
    ...
    let out = ep.collect_thread_events(&event(
        "e1",
        EventMsg::Error(aish_core::protocol::ErrorEvent {
...
fn stream_error_event_produces_error() {
    ...
    let out = ep.collect_thread_events(&event(
        "e1",
        EventMsg::StreamError(aish_core::protocol::StreamErrorEvent {
...
fn task_complete_produces_turn_completed_with_usage() {
    ...
    let usage = aish_core::protocol::TokenUsage {
        input_tokens: 1200,
    ...
    let info = aish_core::protocol::TokenUsageInfo {
