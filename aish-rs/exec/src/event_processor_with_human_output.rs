use aish_common::elapsed::format_duration;
use aish_common::elapsed::format_elapsed;
...
use aish_protocol::num_format::format_with_separators;
...
pub(crate) struct EventProcessorWithHumanOutput {
    ...
    last_total_token_usage: Option<aish_core::protocol::TokenUsageInfo>,
...
impl EventProcessor for EventProcessorWithHumanOutput {
    ...
    fn print_config_summary(
        ...
        ts_msg!(self, "Aish v{} (research preview)\n--------", VERSION);
        ...
        match msg {
            ...
            EventMsg::McpStartupUpdate(update) => {
                let status_text = match update.status {
                    aish_core::protocol::McpStartupStatus::Starting => "starting".to_string(),
                    aish_core::protocol::McpStartupStatus::Ready => "ready".to_string(),
                    aish_core::protocol::McpStartupStatus::Cancelled => "cancelled".to_string(),
                    aish_core::protocol::McpStartupStatus::Failed { ref error } => {
                        format!("failed: {error}")
                    }
                };
                ts_msg!(
            ...
            EventMsg::AgentMessage(AgentMessageEvent { message }) => {
                ts_msg!(
                    self,
                    "{}\n{}",
                    "aish".style(self.italic).style(self.magenta),
                    message,
                );
            }
            ...
            EventMsg::SessionConfigured(session_configured_event) => {
                ...
                ts_msg!(
                    self,
                    "{} {}",
                    "aish session".style(self.magenta).style(self.bold),
