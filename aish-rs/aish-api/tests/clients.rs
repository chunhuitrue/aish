...
use aish_api::ChatClient;
use aish_api::Provider;
use aish_api::ResponsesClient;
use aish_api::ResponsesOptions;
use aish_api::WireApi;
use aish_client::HttpTransport;
use aish_client::Request;
use aish_client::Response;
...
fn provider(name: &str, wire: WireApi) -> Provider {
    Provider {
        ...
        wire,
        headers: HeaderMap::new(),
        retry: aish_api::provider::RetryConfig {
            max_attempts: 1,
