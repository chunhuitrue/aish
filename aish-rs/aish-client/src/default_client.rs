...
impl AishHttpClient {
    ...
    pub fn get<U>(&self, url: U) -> AishRequestBuilder
    where
        U: IntoUrl,
    {
    ...
    pub fn post<U>(&self, url: U) -> AishRequestBuilder
    where
        U: IntoUrl,
    {
    ...
    pub fn request<U>(&self, method: Method, url: U) -> AishRequestBuilder
    where
        U: IntoUrl,
    {
        let url_str = url.as_str().to_string();
        AishRequestBuilder::new(self.inner.request(method.clone(), url), method, url_str)
    }
}

#[must_use = "requests are not sent unless `send` is awaited"]
#[derive(Debug)]
pub struct AishRequestBuilder {
    builder: reqwest::RequestBuilder,
    method: Method,
    url: String,
}

impl AishRequestBuilder {
